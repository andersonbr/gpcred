...
Existem ainda duas formas derivadas da $F_1$ chamadas \textit{micro-$F_1$} e \textit{macro-$F_1$}. A primeria, \textit{micro-$F_1$}, leva em consideração a precisão e a revocação do classificador como um todo. 
