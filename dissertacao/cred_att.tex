...
As métricas usadas para atributos textuais consistem em algumas variantes do \textsc{TFIDF} (\cite{Salton88}), métrica mais difundida entre as apresentadas. A Tabela~\ref{table::metricas_textuais} apresenta a nomeclatura utilizadas pelas métricas aqui listadas.
...
\midrule
    ...
    $M$           & Número de classes da base de dados. \tabularnewline \hline
