...
python runme.py ./gp-cred -treino $treinopath -validacao $validacaopath -teste $testepath -brunoro $brunoro -noterms -g 1 $grafopath -num 15 -knn 1 -knnoptimize -load pop.save
