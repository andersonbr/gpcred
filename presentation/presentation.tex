...
\frame{
    ...
    \end{itemize}
       ...
       \item Foram escritos dois artigos para as conferências SBBD-2010 (melhor da track de Mineração) e CEC-2011.
   \end{itemize}
    \end{center}
...
\frame{
    ...
    \frametitle{Como medir a credibilidade baseada em \textbf{atributos}?}
        
        \begin{itemize}
            \item Classificação de documentos: termos \textbf{Metallica} X \textbf{Anthrax}.
%            \item Desejamos saber a classe do documento \textit{Teste}.
%            \item Calculando P($c_{teste}$ = Música | $t_k$ = Metallica): 
%            \begin{itemize}
%                \item Documento de treino $T_{metal}$ contém a palavra Metallica.
%                \item Documento de treino $T_{saude}$ contém a palavra Anthrax.
%                \item Documento de treino $T_{ambos}$ contém ambas palavras.
%            \end{itemize}
...
\frame{
    ...
    \frametitle{Como medir a credibilidade baseada em \textbf{relacionamentos}?}
...
\section{Programação Genética para Estimar Credibilidade}
\subsection{Geral}
...
\frame{
    ...
    \begin{figure}
    \includegraphics[width=1.0\textwidth]{Figures/gpwf_new.eps}
...
\frame{
   ...
   \begin{figure}[!ht]
        \centering
            ...
            \subfigure[][Função 2:\newline $(\textsc{AM}(x,c) + \textsc{P}(x|c)) \% (\textsc{IG}(x,c))$]{
...
\frame{
  ...
  \item <2-> Macro-$F_1$: Considera a $F_1$ de cada classe e realiza uma média ao final.
    ...
    \begin{itemize}
        \item Sujeito a valores ruins se um das classes for muito difícil.
    \end{itemize}
...
\frame{
  \frametitle{Experimentos - Bases}
    ...
    Descricaoo....primeiro fiz classificacao atributos, relacionamentos, etc...

\begin{itemize}

    \item Usamos ao todo 9 bases:

    \begin{enumerate}
        \item 4 de textos.
        \item 4 de atributos categóricos.
        \item 1 de bioinformática.
    \end{enumerate}
...
\begin{figure}[!h]
  \centering
  \subfigure[][ACM-DL]{\label{fig::acm}\includegraphics[angle=270, width=0.30\textwidth]{Figures/acm.eps}}
  \subfigure[][Reuters]{\label{fig::reuters}\includegraphics[angle=270, width=0.30\textwidth]{Figures/reuters.eps}}
    \\
  \subfigure[][Ohsumed]{\label{fig::ohsumed}\includegraphics[angle=270, width=0.30\textwidth]{Figures/ohsumed.eps}}
  \subfigure[][20-NewsGroup]{\label{fig::20ng}\includegraphics[angle=270, width=0.30\textwidth]{Figures/20ng.eps}}
...
\begin{figure}[h]
  \centering
  \subfigure[][cars]{\label{fig::cars}\includegraphics[angle=270, width=0.30\textwidth]{Figures/cars.eps}}
  \subfigure[][chess]{\label{fig::chess}\includegraphics[angle=270, width=0.30\textwidth]{Figures/chess.eps}}
  \subfigure[][nursery]{\label{fig::nursery}\includegraphics[angle=270, width=0.30\textwidth]{Figures/nursery.eps}}
    \\
  \subfigure[][tictactoe]{\label{fig::tictactoe}\includegraphics[angle=270, width=0.30\textwidth]{Figures/tictactoe.eps}}
  \subfigure[][Assinaturas Estruturais Proteicas]{\label{fig::astral}\includegraphics[angle=270, width=0.30\textwidth]{Figures/astral.eps}}
...
\begin{itemize}
\item Todos experimentos realizados com validação cruzada.
...
\frame{
    ...
    \frametitle{Experimentos - Múltiplos fatores}
...
\frame{
  ...
  \begin{itemize}
    ...
    \vskip0.5cm
    \item Modelamos a credibilidade usando dois fatores: os atributos e os relacionamentos entre os exemplos.
    \vskip0.5cm
    \item Os atributos foram modelados através de métricas indicadoras de separação de classe.
    \vskip0.5cm
    \item Os relacionamentos foram modelados usando Redes Complexas.
    \vskip0.5cm
...
\frame{
  ...
  \begin{itemize}
    ...
    \begin{enumerate}
        \item Incorporar a credibilidade em outros classificadores: \textsc{SVM}, árvores de decisão.
            \vskip0.25cm
