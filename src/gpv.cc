...
void GPVariables::printOn (ostream& os)
{
  ...
  switch (CreationType)
    ...
    case GPUserDefinedCreation:
      ...
      break;
    default:
      GPExitSystem ((char*)"GPVariables::printOn", (char*)"Wrong creation type");
    }
  ...
  switch (SelectionType)
    ...
    case GPUserDefinedSelection:
      ...
      break;
    default:
      GPExitSystem ((char*)"GPVariables::printOn", (char*)"Wrong selection type");
    }
  os << "\nTournamentSize            = " << TournamentSize
     ...
     << "\nActiveGPMode		     = " << ActiveGPMode
     << "\nGenToChangeTrain          = " << GenToChangeTrain
     << endl;
}
